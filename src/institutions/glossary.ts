...
export const GLOSSARY_ENTRIES: readonly GlossaryEntry[] = [
  ...
  // (there is no GlossaryCategory "ops"; ops.palette itself is category "ui").
  {
    ...
    seeAlso: ["partner.phase.onboarding", "partner.phase.incomplete", "partner.phase.paused", "partner.authorization.grant"],
    tone: "concept",
    added: "2026-07-31",
  },
  {
  ...
  },
  {
    ...
    seeAlso: ["out.status.deferred", "out.status.paused", "partner.phase.operator_ready", "partner.authorization.grant"],
    tone: "concept",
    added: "2026-07-31",
  },
  {
  ...
  },
  {
    ...
    seeAlso: ["event.telegram.invite_sent", "accounting.deposit", "partner.authorization.request", "partner.execution.receipt"],
    tone: "alert",
    added: "2026-07-31",
  },
  {
    id: "partner.authorization.request",
    kind: "composite",
    label: "Authorization request",
    description: "Pending partner policy snapshot whose immutable terms and Telegram provenance are bound by a canonical SHA-256 hash.",
    category: "pipeline",
    color: "middleware",
    status: "active",
    synonyms: ["approval request", "policy hash", "account_authorization_requests"],
    seeAlso: ["partner.authorization.grant", "event.telegram.message_pinned", "partner.phase.onboarding"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.authorization.grant",
    kind: "composite",
    label: "Active authorization grant",
    description: "Non-revoked, currently valid SQLite grant for an exact partner, out, provider, skin, scope, limits, currency, and approval provenance tuple.",
    category: "pipeline",
    color: "tennis",
    status: "active",
    synonyms: ["live_trade grant", "account_authorizations", "approved authorization"],
    seeAlso: ["partner.authorization.request", "partner.execution.gate", "partner.phase.operator_ready", "out.status.ready"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.execution.gate",
    kind: "composite",
    label: "Authorized execution gate",
    description: "Fail-closed decision boundary that verifies the active grant, policy hash, freshness, integer stake caps, provider session, and risk health before reservation.",
    category: "trading",
    color: "trading",
    status: "active",
    synonyms: ["execution gate", "evaluateExecutionGate", "risk gate"],
    seeAlso: ["partner.authorization.grant", "partner.execution.reservation", "provider.polymarket.intelligence_only", "liquidity_ok", "exposureCents"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.execution.reservation",
    kind: "composite",
    label: "Exposure reservation",
    description: "Transactional integer-minor-unit hold that prevents concurrent orders from exceeding daily, balance, liquidity, or outstanding-exposure limits.",
    category: "trading",
    color: "kalshi",
    unit: "cents",
    status: "active",
    synonyms: ["exposure_reservations", "pending reservation", "effective stake"],
    seeAlso: ["partner.execution.gate", "partner.execution.provider_lifecycle", "exposureCents", "balanceCents"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.execution.provider_lifecycle",
    kind: "composite",
    label: "Provider order lifecycle",
    description: "Normalized provider outcome across accepted, resting, partial-fill, filled, canceled, rejected, ambiguous, and settled states with deterministic reconciliation.",
    category: "trading",
    color: "kalshi",
    status: "active",
    synonyms: ["Kalshi lifecycle", "order reconciliation", "provider lifecycle"],
    seeAlso: ["partner.execution.reservation", "partner.execution.journal", "remainingCount", "fillCount"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.execution.journal",
    kind: "composite",
    label: "Authorized execution journal",
    description: "Immutable audit record and projections for requests, reservations, provider evidence, cash, exposure, fees, realized P&L, and partner split.",
    category: "trading",
    color: "research",
    status: "active",
    synonyms: ["execution journal", "provider lifecycle journal", "audit trail"],
    seeAlso: ["partner.execution.provider_lifecycle", "partner.execution.receipt", "snapshot.visual.provenance", "realizedPnlCents", "feesPaidCents"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "partner.execution.receipt",
    kind: "composite",
    label: "Durable partner receipt",
    description: "Retryable outbox message carrying an authorization or execution outcome back to the bound Telegram chat and topic without granting execution authority.",
    category: "pipeline",
    color: "middleware",
    status: "active",
    synonyms: ["receipt outbox", "Telegram receipt", "durable receipt"],
    seeAlso: ["partner.execution.journal", "event.telegram.message_pinned", "alert.delivery"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    id: "provider.polymarket.intelligence_only",
    kind: "composite",
    label: "Polymarket intelligence only",
    description: "Public Gamma market data may support matching and regulatory line-move intelligence, but cannot authorize an account or prove an execution outcome.",
    category: "pipeline",
    color: "polymarket",
    status: "active",
    synonyms: ["Polymarket read-only", "Gamma intelligence", "no Polymarket execution"],
    seeAlso: ["poly_mid", "poly_volume", "ui.warehouse.poly_link", "partner.execution.gate"],
    tone: "concept",
    added: "2026-08-06",
  },
  {
    ...
    color: "research",
    status: "active",
    synonyms: ["snapshot meta", "Bun.Image metadata", "WebView evidence"],
    seeAlso: ["partner.execution.journal", "liquidity_ok", "desk.tradable"],
    tone: "concept",
    added: "2026-08-06",
  },
] as const;
...
export const PAGE_SURFACES = {
  ...
  ops: [
    ...
    "partner.execution.receipt", "provider.polymarket.intelligence_only",
