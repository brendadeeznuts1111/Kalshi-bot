 ...
 * AdapterId follows the suggested skin's mapper — Ultra stack is not scored here.
 */
...
export function adapterIdForMappedSkin(skinId: SkinId): AdapterId {
  return adapterBindingForSkin(skinId).adapterId;
}
