...
export const ROUTE_MANIFEST: readonly RouteDef[] = [
  ...
  { path: '/showcase', method: 'GET', layer: 'branding', handler: 'driven Odds Heat showcase (Bun.markdown + manifest)', cache: 'no-cache', docRef: 'docs/odds-heat-showcase.html' },
  { path: '/api/showcase', method: 'GET', layer: 'data', handler: 'showcase data as JSON (stats, sections, links)', cache: 'no-cache', docRef: 'docs/odds-heat-showcase.html' },
  { path: '/sitemap.xml', method: 'GET', layer: 'research', handler: 'sitemap generated by sitemap:gen (Bun.XML @attr, §240)', cache: '1h', docRef: 'docs/ODDS_REGISTRY.md' },
