...
| [`BUN_BUILD_FINDINGS.md`](BUN_BUILD_FINDINGS.md) | Bun API findings grounded on 1.4.0: 9 surfaces — 97 cross-check claims (89 CONSISTENT, 8 PINNED-DISCREPANCY), ZERO coverage gaps (178; deep pass closed the last 4) |
